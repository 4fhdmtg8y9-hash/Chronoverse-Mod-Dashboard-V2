    ...
    return Response.json(
      {
        success: false,
        error:
          "You do not have permission to review inactivity notices."
      },
      {
        status: 403
      }
      ...
      return Response.json(
        {
          success: false,
          error:
            "Inactivity notice could not be reviewed"
        },
        {
          status: 400
        }
    ...
    return Response.json(
      {
        success: false,
        error:
          "Unable to review inactivity notice"
      },
      {
        status: 500
      }
